...
# SENSITIVITY PLOTS
#------------------------------------------------------------------------------
def plot_sensitivities(scheme, null_net, normalized=False, labels=True):
    ...
    plt.savefig(f"../{folder}/sensitivities/{scheme}_{null_net}_sensitivity_{connectomes[data_idx]}.pdf", 
                dpi=600)
    plt.show()
...
#------------------------------------------------------------------------------
# Plot sensitivities
plot_sensitivities('constant', 'rand_weight', normalized=True)
plot_sensitivities('proportional', 'rand_weight', normalized=True)

# Plot sensitivity histograms
plot_sensitivity_hist('constant', 'rand_weight', normalized=True)
plot_sensitivity_hist('proportional', 'rand_weight', normalized=True)

# Plot sensitivities (no labels)
plot_sensitivities('constant', 'rand_weight', normalized=True, labels=False)
plot_sensitivities('proportional', 'rand_weight', normalized=True, labels=False)

# Plot sensitivity histograms (no labels)
plot_sensitivity_hist('constant', 'rand_weight', normalized=True, labels=False)
plot_sensitivity_hist('proportional', 'rand_weight', normalized=True, labels=False)
